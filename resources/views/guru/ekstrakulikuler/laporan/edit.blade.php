...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <!-- form start -->
        <form action="{{ route('LaporanEkskul.update',$laporan->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('patch')
            <div class="card-body">
                <div class="row">
                @if(Auth::user()->role == 'Admin')
                    <div class="col-md-12 required">
                        ...
                        <label for="nama_ekskul">Pembina Ekstrakurikuler</label>
                            <select id="pembina_ekskul" name="pembina_ekskul" class="select2bs4 form-control @error('pembina_ekskul') is-invalid @enderror">
                                <option value="">-- Select {{ __('Pembina') }} --</option>
						            ...
						            <option value="{{ $data->id }}" {{ old('pembina_ekskul') == $data->id || $laporan->user_id == $data->id ? 'selected' : '' }}>{{ $data->name }}</option>
				                    @endforeach
                            </select>
                        </div>
                    </div>
                @else
                   ...
                   <div class="col-md-12">
                        ...
                        <label for="pembina_ekskul">Pembina Ekstrakurikuler</label>
                            <a readonly type="text" id="pembina_ekskul" name="pembina_ekskul" class="form-control @error('pembina_ekskul') is-invalid @enderror" value="{{ Auth::user()->id }}">{{ Auth::user()->name }}</a>
                        </div>
                    </div>
                @endif
                    <div class="col-md-12 required">
                        ...
                        <label for="nama_ekskul">Ekstrakurikuler</label>
                            <select id="nama_ekskul" name="nama_ekskul" class="select2bs4 form-control @error('nama_ekskul') is-invalid @enderror">
                                ...
                                @foreach ($ekskul as $data)
						            <option value="{{ $data->nama_ekstra }}" {{ old('nama_ekskul') == $data->nama_ekstra || $laporan->nama_ekskul == $data->nama_ekstra ? 'selected' : '' }}>{{ $data->nama_ekstra }}</option>
				                @endforeach    
                            </select>
                        </div>
                    </div>
                    <div class="col-md-12 required">
                        ...
                        <label for="nama_ekskul">Jumlah Kegiatan</label>
                            <select id="jml_kegiatan" name="jml_kegiatan" class="select2bs4 form-control @error('jml_kegiatan') is-invalid @enderror">
                                <option value="">-- Select {{ __('PILIH JUMLAH KEGIATAN') }} --</option>
						            <option value="1" {{ old('jml_kegiatan') == '1' || $laporan->jml_kegiatan == '1' ? 'selected' : '' }}>1</option>
                                    <option value="2" {{ old('jml_kegiatan') == '2' || $laporan->jml_kegiatan == '2' ? 'selected' : '' }}>2</option>
                                    <option value="3" {{ old('jml_kegiatan') == '3' || $laporan->jml_kegiatan == '3' ? 'selected' : '' }}>3</option>
                                    <option value="4" {{ old('jml_kegiatan') == '4' || $laporan->jml_kegiatan == '4' ? 'selected' : '' }}>4</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="tgl_pelaksanaan_m1">Tanggal Pelaksanaa</label>
                            ...
                            <input type="date" id="tgl_pelaksanaan_m1" name="tgl_pelaksanaan_m1" class="form-control @error('tgl_pelaksanaan_m1') is-invalid @enderror" value="{{ old('tgl_pelaksanaan_m1', $laporan->tgl_pelaksanaan_m1->translatedFormat('Y-m-d') ?? '') }}">
                            @else
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="kegiatan_ekskul_m2" name="kegiatan_ekskul_m2" class="form-control @error('kegiatan_ekskul_m2') is-invalid @enderror">{{ old('kegiatan_ekskul_m2', $laporan->kegiatan_ekskul_m2 ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="tgl_pelaksanaan_m2">Tanggal Pelaksanaa</label>
                            ...
                            <input type="date" id="tgl_pelaksanaan_m2" name="tgl_pelaksanaan_m2" class="form-control @error('tgl_pelaksanaan_m2') is-invalid @enderror" value="{{ old('tgl_pelaksanaan_m2', $laporan->tgl_pelaksanaan_m2->translatedFormat('Y-m-d') ?? '') }}">
                            @else
                    ...
                    <div class="col-md-8">
                        ...
                        <label for="tmp_pelaksanaan_m2">Tempat Pelaksanaa</label>
                            <input type="text" id="tmp_pelaksanaan_m2" name="tmp_pelaksanaan_m2" class="form-control @error('tmp_pelaksanaan_m2') is-invalid @enderror" value="{{ old('tmp_pelaksanaan_m2', $laporan->tmp_pelaksanaan_m2 ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        <label for="jml_peserta_m2">Jumlah Peserta</label>
                            <input type="number" id="jml_peserta_m2" name="jml_peserta_m2" class="form-control @error('jml_peserta_m2') is-invalid @enderror" value="{{ old('jml_peserta_m2', $laporan->jml_peserta_m2 ?? '') }}">
                        </div>
                    </div>
                    <div id="beasiswa_required" class="col-md-4">
                        <div class="form-group has-validation">
                            ...
                            <br>
                            <img src="{{ asset(''.$laporan->foto_ekskul_m2) }}" width="150">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="kegiatan_ekskul_m3" name="kegiatan_ekskul_m3" class="form-control @error('kegiatan_ekskul_m3') is-invalid @enderror">{{ old('kegiatan_ekskul_m3', $laporan->kegiatan_ekskul_m3 ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="tgl_pelaksanaan_m3">Tanggal Pelaksanaa</label>
                            ...
                            <input type="date" id="tgl_pelaksanaan_m3" name="tgl_pelaksanaan_m3" class="form-control @error('tgl_pelaksanaan_m3') is-invalid @enderror" value="{{ old('tgl_pelaksanaan_m3', $laporan->tgl_pelaksanaan_m3->translatedFormat('Y-m-d') ?? '') }}">
                            @else
                    ...
                    <div class="col-md-8">
                        ...
                        <label for="tmp_pelaksanaan_m3">Tempat Pelaksanaa</label>
                            <input type="text" id="tmp_pelaksanaan_m3" name="tmp_pelaksanaan_m3" class="form-control @error('tmp_pelaksanaan_m3') is-invalid @enderror" value="{{ old('tmp_pelaksanaan_m3', $laporan->tmp_pelaksanaan_m3 ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        <label for="jml_peserta_m3">Jumlah Peserta</label>
                            <input type="number" id="jml_peserta_m3" name="jml_peserta_m3" class="form-control @error('jml_peserta_m3') is-invalid @enderror" value="{{ old('jml_peserta_m3', $laporan->jml_peserta_m3 ?? '') }}">
                        </div>
                    </div>
                    <div id="beasiswa_required" class="col-md-4">
                        <div class="form-group has-validation">
                            ...
                            <br>
                            <img src="{{ asset(''.$laporan->foto_ekskul_m3) }}" width="150">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="kegiatan_ekskul_m4" name="kegiatan_ekskul_m4" class="form-control @error('kegiatan_ekskul_m4') is-invalid @enderror">{{ old('kegiatan_ekskul_m4', $laporan->kegiatan_ekskul_m4 ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="tgl_pelaksanaan_m4">Tanggal Pelaksanaa</label>
                            ...
                            <input type="date" id="tgl_pelaksanaan_m4" name="tgl_pelaksanaan_m4" class="form-control @error('tgl_pelaksanaan_m4') is-invalid @enderror" value="{{ old('tgl_pelaksanaan_m4', $laporan->tgl_pelaksanaan_m4->translatedFormat('Y-m-d') ?? '') }}">
                            @else
                    ...
                    <div class="col-md-8">
                        ...
                        <label for="tmp_pelaksanaan_m4">Tempat Pelaksanaa</label>
                            <input type="text" id="tmp_pelaksanaan_m4" name="tmp_pelaksanaan_m4" class="form-control @error('tmp_pelaksanaan_m4') is-invalid @enderror" value="{{ old('tmp_pelaksanaan_m4', $laporan->tmp_pelaksanaan_m4 ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        <label for="jml_peserta_m4">Jumlah Peserta</label>
                            <input type="number" id="jml_peserta_m4" name="jml_peserta_m4" class="form-control @error('jml_peserta_m4') is-invalid @enderror" value="{{ old('jml_peserta_m4', $laporan->jml_peserta_m4 ?? '') }}">
                        </div>
                    </div>
                    <div id="beasiswa_required" class="col-md-4">
                        <div class="form-group has-validation">
                            ...
                            <br>
                            <img src="{{ asset(''.$laporan->foto_ekskul_m4) }}" width="150">
                        </div>
                    </div>
                </div>
            </div>
