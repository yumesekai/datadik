...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <!-- form start -->
        <form action="{{ route('smp.updateSiswa') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <input type="text" id="id" name="id" value="{{ Auth::user()->tem_smp(Auth::user()->id)->id }}" class="form-control d-none" readonly>
                    <div class="col-md-12 required">
                        <div class="form-group">
                            <label for="kelas">Nama Sekolah SMP</label>
                            <input type="text" id="sekolah_asal" name="sekolah_asal" value="{{ Auth::user()->tem_smp(Auth::user()->id)->sekolah_asal }}" class="form-control @error('sekolah_asal') is-invalid @enderror">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="kelas">Nomer Ujian Nasional</label>
                            <input type="text" id="no_un" name="no_un" value="{{ Auth::user()->tem_smp(Auth::user()->id)->no_un }}" class="form-control @error('no_un') is-invalid @enderror">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="kelas">Nomer SKHUN</label>
                            <input type="text" id="no_skhun" name="no_skhun" value="{{ Auth::user()->tem_smp(Auth::user()->id)->no_skhun }}" class="form-control @error('no_skhun') is-invalid @enderror">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="kelas">Nomer Ijasah</label>
                            <input type="text" id="no_ijasah" name="no_ijasah" value="{{ Auth::user()->tem_smp(Auth::user()->id)->no_ijasah }}" class="form-control @error('no_ijasah') is-invalid @enderror">
                        </div>
                    </div>
