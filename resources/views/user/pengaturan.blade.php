            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    @elseif (Auth::user()->role == 'Siswa')
                        <a href="" data-toggle="lightbox" data-title="Foto {{ Auth::user()->name }}" data-gallery="gallery" data-footer='<a href="{{ route('pengaturan.edit-foto') }}" id="linkFotoGuru" class="btn btn-link btn-block btn-light"><i class="nav-icon fas fa-file-upload"></i> &nbsp; Ubah Foto</a>'>
                    ...
                    @elseif (Auth::user()->role == 'Siswa')
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>No INduk</b> <a class="float-right"></a>
                            </li>
                            <li class="list-group-item">
                                <b>NIS</b> <a class="float-right"></a>
                            </li>
                        </ul>
                    @else
                    @endif
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>Ubah Password</td>
                        <td width="50"><a href="{{ route('user.password') }}" class="btn btn-default btn-sm">Edit</a></td>
                    </tr>
                    </table>
                </div>
            </div>
