...
@section('heading','Ajuan Perubahan Data Priodik')
@section('page')
  <li class="breadcrumb-item active">Pengajuan Data Priodik</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
            ...
            <tbody>
                @foreach ($pending as $data)
                    <tr>
                        ...
                        <td>{{ $data->priodik->user->email }}</td>
                        <td>{{ $data->priodik->user->name }}</td>
                        <td>{{ $data->priodik->user->kelas->nama_kelas }}</td>
                        <td>
                        ...
                        <td>
                            <a href="{{ route('TemPriodik.edit', Crypt::encrypt($data->id)) }}" class="btn btn-warning btn-sm mt-2"><i class="nav-icon fas fa-edit"></i> &nbsp; Detail</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
