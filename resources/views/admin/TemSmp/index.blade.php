...
@section('heading','Ajuan Perubahan Data SMP')
@section('page')
  <li class="breadcrumb-item active">Pengajuan Data SMP</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
            ...
            <tbody>
                @foreach ($pending as $data)
                    <tr>
                        ...
                        <td>{{ $data->smp->user->email }}</td>
                        <td>{{ $data->smp->user->name }}</td>
                        <td>{{ $data->smp->user->kelas->nama_kelas }}</td>
                        <td>
                        ...
                        <td>
                            <a href="{{ route('TemSmp.edit', Crypt::encrypt($data->id)) }}" class="btn btn-warning btn-sm mt-2"><i class="nav-icon fas fa-edit"></i> &nbsp; Detail</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
