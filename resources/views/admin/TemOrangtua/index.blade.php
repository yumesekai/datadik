...
@section('heading','Ajuan Perubahan Data Orang Tua')
@section('page')
  <li class="breadcrumb-item active">Pengajuan Data Orang Tua</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
            ...
            <tbody>
                @foreach ($pending as $data)
                    <tr>
                        ...
                        <td>{{ $data->orangtua->user->email }}</td>
                        <td>{{ $data->orangtua->user->name }}</td>
                        <td>{{ $data->orangtua->user->kelas->nama_kelas }}</td>
                        <td>
                        ...
                        <td>
                            <a href="{{ route('TemOrangtua.edit', Crypt::encrypt($data->id)) }}" class="btn btn-warning btn-sm mt-2"><i class="nav-icon fas fa-edit"></i> &nbsp; Detail</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
